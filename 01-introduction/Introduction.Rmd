...
abline(lm(y[abs(x  - 2) < 0.35] ~ x[abs(x  - 2) < 0.35]),  
       col = "red",  
       lty = 2)
```
...
segments(x0 = 3, 
         x1 = 4.5, 
         y0 = sum(lm(y ~ D)$coefficients), 
         y1 = sum(lm(y ~ D)$coefficients),
         col = "red",
         lty = 2)

segments(x0 = 1.5,
         x1 = 3, 
         y0 = lm(y ~ D)$coefficients[1], 
         y1 = lm(y ~ D)$coefficients[1], 
         col = "red", 
         lty = 2)
