---
title: "TAセッション１: イントロダクション"
subtitle: "〜統計学・計量経済学の復習を添えて〜"
author: 'TA: 北川 梨津'
...
set.seed(0); x <- rnorm(50, 2); y <- 4 + 3*x + rnorm(50, 0, 2);
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), col = "white", axes=FALSE)
abline(v = 0);abline(h = 0); abline(4, 3, col = "red")
```
...
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), col = "white", axes=FALSE)
abline(v = 0); abline(h = 0); abline(4, 3, col = "red")
par(new = T); plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE)
```

---
$$\{ Y_i, X_i \}_{i=1}^n.$$
```{r echo=FALSE, fig.align='center', out.width='50%'}
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE)
...
```{r echo=FALSE, fig.align='center', out.width='50%'}
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE)
abline(v = 0); abline(h = 0); abline(lm(y ~ x), col = "red", lty = 2)
```
...
```{r echo=FALSE, fig.align='center', out.width='50%'}
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE)
abline(v = 0); abline(h = 0); abline(4, 1, col = "red", lty = 2)
```
...
```{r echo=FALSE, fig.align='center', out.width='50%'}
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE)
abline(v = 0); abline(h = 0); abline(0, 5, col = "red", lty = 2)
```
...
```{r echo=FALSE, fig.align='center', out.width='50%'}
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE)
abline(v = 0); abline(h = 0); abline(-5, 4, col = "red")
```
...
```{r echo=FALSE, fig.align='center', out.width='50%'}
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE)
abline(v = 0); abline(h = 0); abline(30.5, -10.072, col = "red")
```
...
---
```{r echo=FALSE}
set.seed(0); X <- rnorm(100, 2); Y <- 5 + 3*X + rnorm(100, 0, 1)
```

$R^2=$ `r round(summary(lm(Y ~ X))$r.squared, 2)` 

```{r echo=FALSE, fig.align='center', out.width='50%'}
set.seed(0); X <- rnorm(100, 2); Y <- 5 + 3*X + rnorm(100, 0, 1)
plot(X, Y, pch = 16, xlim = c(-0.5, 4), ylim = c(-1, 20), axes=FALSE)
abline(v = 0); abline(h = 0); abline(lm(Y ~ X), col = "red", lty = 2)
```

---
```{r echo=FALSE}
set.seed(0); X <- rnorm(100, 2); Y <- 5 + 3*X + rnorm(100, 0, 3)
```
...
---
```{r echo=FALSE, fig.align='center', out.width='50%'}
plot(x, y, pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE, col = "grey")
abline(v = 0); abline(h = 0); abline(4, 3, col = "red")
par(new =  T)
plot(x[abs(x  - 2) < 0.35], y[abs(x  - 2) < 0.35], pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE, xlab = "", ylab = "")
```
...
par(new =  T)
plot(x[abs(x  - 2) < 0.35], y[abs(x  - 2) < 0.35], pch = 16, xlim = c(-1, 4.5), ylim = c(-1, 20), axes=FALSE, xlab = "", ylab = "")
abline(lm(y[abs(x  - 2) < 0.35] ~ x[abs(x  - 2) < 0.35]),  col = "red",  lty = 2)
```
...
```{r echo=FALSE, fig.align='center', out.width='50%'}
set.seed(0); x <- rnorm(100, 3); y <- -5 +10*x - 1.1*x^2 + rnorm(100)
plot(x, y, pch = 16, xlim = c(-1, 6), ylim = c(-1, 20), axes=FALSE)
abline(v = 0)
abline(h = 0)
```
---
...
abline(v = 0)
abline(h = 0)
lines(x[ix], pred[ix], col='red', lwd =2, lty=2)
```
...
```{r echo=FALSE, fig.align='center', out.width='50%'}
set.seed(0); x <- rnorm(100, 3); D <- 1 * (x + rnorm(100)>3); y <- -5 +10*x - 20*D + rnorm(100)
plot(x, y, pch = 16, xlim = c(-1, 6), ylim = c(-1, 40), axes=FALSE, col = "white")
par(new = T)
plot(x[D==1], y[D==1], pch = 16, xlim = c(-1, 6), ylim = c(-1, 40), xlab="", ylab = "", axes=FALSE, col = "lightblue")
par(new = T)
plot(x[D==0], y[D==0], pch = 16, xlim = c(-1, 6), ylim = c(-1, 40), xlab="", ylab = "", axes=FALSE, col = "pink")
fit <- lm(y ~ x)
pred <- predict(fit)
ix <- sort(x, index.return=T)$ix
abline(v = 0)
...
par(new = T)
plot(x[D==0], y[D==0], pch = 16, xlim = c(-1, 6), ylim = c(-1, 40), xlab="", ylab = "", axes=FALSE, col = "pink")
segments(x0 = 3, x1 = 4.5, y0 = sum(lm(y ~ D)$coefficients), y1 = sum(lm(y ~ D)$coefficients), col = "red", lty = 2)
segments(x0 = 1.5, x1 = 3, y0 = lm(y ~ D)$coefficients[1], y1 = lm(y ~ D)$coefficients[1], col = "red", lty = 2)
abline(v = 0)
abline(h = 0)
```
...
par(new = T)
plot(x[D==0], y[D==0], pch = 16, xlim = c(-1, 6), ylim = c(-1, 40), xlab="", ylab = "", axes=FALSE, col = "pink")
segments(x0 = 0.7, x1 = 5.5, y0 = 1.8866, y1 = 50.261, col = "red", lty = 2)
segments(x0 = 0.7, x1 = 5.5, y0 = 1.8866-20.001, y1 = 50.261-20.001, col = "red", lty = 2)
abline(v = 0)
abline(h = 0)
```
